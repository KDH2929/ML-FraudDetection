...
OUTPUT_DIR = ARTIFACTS_DIR / "member_c_strategy_4_custom"
OUTPUT_PATH = OUTPUT_DIR / "member_c_strategy_4_custom_tuning_results.json"
COMPAT_OUTPUT_PATH = ARTIFACTS_DIR / f"{STRATEGY_ID}_tuning_results.json"
